...
public class AppointmentGUI {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AppointmentGUI window = new AppointmentGUI("max.endres@stud");
     ...
     */
    public AppointmentGUI(String mail) {
        ...
        btnSend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Connect.insertAppointment(sqlTime, sqlDate, loggedInUser, "doctormailing");
                } catch (Exception e1) {
